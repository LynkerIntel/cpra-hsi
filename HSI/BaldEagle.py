...
class BaldEagleHSI:
    ...
    v1_pct_cell_land_or_upland: np.ndarray = None
    ...
    def calculate_si_1(self) -> np.ndarray:
        """Percent of cell that is land or upland."""
        # Calculate for inital conditions and use for all time periods
        
        if self.v1_pct_cell_land_or_upland is None:
            self._logger.info("Pct land or upland data not provided. Setting index to 1.")
            ...
            mask_1 = self.v1_pct_cell_land_or_upland <= 0.0
            si_1[mask_1] =  0.01

            # condition 2 (otherwise)
            mask_2 = self.v1_pct_cell_land_or_upland > 0.0
            si_1[mask_2] = 0.408 + 0.142 * np.log(self.v1_pct_cell_land_or_upland[mask_2])
