...
class BlackCrappieHSI:
    ...
    def calculate_si_1(self) -> np.ndarray:
        ...
        if self.v1_max_monthly_avg_summer_turbidity is None:
            ...
            # condition 2
            mask_2 = (
                (self.v1_max_monthly_avg_summer_turbidity >= 50) & 
    ...
    def calculate_si_2(self) -> np.ndarray:
        ...
        if self.v2_pct_cover_in_midsummer_pools_overflow_bw is None:
            ...
            # condition 1 
            mask_1 = (self.v2_pct_cover_in_midsummer_pools_overflow_bw >= 25) & (
                self.v2_pct_cover_in_midsummer_pools_overflow_bw < 85
            )
            si_2[mask_1] = 1

            # condition 2
            mask_2 = (self.v2_pct_cover_in_midsummer_pools_overflow_bw >= 0) & (
    ...
    def calculate_si_7(self) -> np.ndarray:
        ...
        if self.v7_ph_year is None:
            ...
            # condition 2
            mask_2 = (self.v7_ph_year > 6.5) & (
                self.v7_ph_year <= 8.5
            )
            si_7[mask_2] = 1

            # condition 3
            mask_3 = (self.v7_ph_year > 4.5) & (
                self.v7_ph_year <= 6.5
            )
            si_7[mask_3] =  (
                0.5 * (self.v7_ph_year [mask_3])
                - 2.25
            )

            # condition 4
            mask_4 = (self.v7_ph_year > 8.5) & (
                self.v7_ph_year <= 9.5
            )
            si_7[mask_4] =  (
    ...
    def calculate_si_8(self) -> np.ndarray:
        ...
        if self.v8_most_suit_temp_in_midsummer_pools_bw_adult is None:
            ...
            # condition 1 
            mask_1 = (self.v8_most_suit_temp_in_midsummer_pools_bw_adult <= 14) | (
                self.v8_most_suit_temp_in_midsummer_pools_bw_adult > 34
            )
            si_8[mask_1] = 0

            # condition 2
            mask_2 = (self.v8_most_suit_temp_in_midsummer_pools_bw_adult > 23) & (
                self.v8_most_suit_temp_in_midsummer_pools_bw_adult <= 27
            )
            si_8[mask_2] = 1

            # condition 3
            mask_3 = (self.v8_most_suit_temp_in_midsummer_pools_bw_adult > 14) & (
            ...
            # condition 4
            mask_4 = (self.v8_most_suit_temp_in_midsummer_pools_bw_adult > 27) & (
                self.v8_most_suit_temp_in_midsummer_pools_bw_adult <= 34
            )
            si_8[mask_4] = (
    ...
    def calculate_si_9(self) -> np.ndarray:
        ...
        if self.v9_most_suit_temp_in_midsummer_pools_bw_juvenile is None:
            ...
            # condition 1 
            mask_1 = (self.v9_most_suit_temp_in_midsummer_pools_bw_juvenile <= 11) | (
                self.v9_most_suit_temp_in_midsummer_pools_bw_juvenile >= 30
            )
            si_9[mask_1] = 0

            # condition 2
            mask_2 = (self.v9_most_suit_temp_in_midsummer_pools_bw_juvenile > 22) & (
                self.v9_most_suit_temp_in_midsummer_pools_bw_juvenile <= 24
            )
            si_9[mask_2] = 1

            # condition 3
            mask_3 = (self.v9_most_suit_temp_in_midsummer_pools_bw_juvenile > 11) & (
            ...
            # condition 4
            mask_4 = (self.v9_most_suit_temp_in_midsummer_pools_bw_juvenile > 24) & (
                self.v9_most_suit_temp_in_midsummer_pools_bw_juvenile < 30
            )
            si_9[mask_4] = (
    ...
    def calculate_overall_suitability(self) -> np.ndarray:
        ...
        wq_tcr_mask = (self.si_8 <= 0.4) | (self.si_9 <= 0.4) | (self.si_10 <= 0.4)
        self.wq_tcr_adj = np.where(wq_tcr_mask, np.minimum.reduce([self.si_8, self.si_9, self.si_10]), self.wq_tcr)

        # water quality initial equation
        self.wq_init = (2 * (self.wq_tcr_adj) + 
            2 * (self.si_12) + self.si_7 + self.si_1
        ) / 6

        # condition 2
        wq_mask = ((self.wq_tcr_adj) <= 0.4) | (self.si_12 <= 0.4) 
        self.wq = np.where(wq_mask, np.minimum.reduce(
            [self.wq_tcr_adj, self.si_12, self.wq_init]), self.wq_init)

        # reproduction component (rc)
        self.rc = (
            (((self.si_2) * (self.si_5) * (self.si_11 ** (2)) * 
               (self.si_13 ** (2))) ** (1/6))
        )
