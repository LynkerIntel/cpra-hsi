...
class BottomlandHardwoodHSI:
    ...
    def from_hsi(cls, hsi_instance):
        ...
        return cls(
            ...
            v1b_pct_overstory_w_mast=hsi_instance.pct_overstory_w_mast,
            v1c_pct_overstory_w_soft_mast=hsi_instance.pct_overstory_w_soft_mast,
            v1d_pct_overstory_w_hard_mast=hsi_instance.pct_overstory_w_hard_mast,
            ...
            v6a_pct_blh_forested_marsh_half_mi=hsi_instance.pct_blh_forested_marsh_half_mi, 
            v6b_pct_aban_agri_dense_cover_half_mi=hsi_instance.pct_aban_agri_dense_cover_half_mi,
            v6c_pct_pasture_hay_half_mi=hsi_instance.pct_pasture_hay_half_mi, 
            v6d_pct_agri_water_half_mi=hsi_instance.pct_agri_water_half_mi,
